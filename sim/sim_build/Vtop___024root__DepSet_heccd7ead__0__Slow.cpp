...
#endif
            VL_FATAL_MT("/home/hex/Desktop/INT_ACCEL/sim/../rtl/soc_top.v", 13, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->soc_top__DOT__w_route_s1 = VL_RAND_RESET_I(1);
    vlSelf->soc_top__DOT__current_w_route = VL_RAND_RESET_I(1);
    vlSelf->soc_top__DOT__r_route_s1 = VL_RAND_RESET_I(1);
    vlSelf->soc_top__DOT__current_r_route = VL_RAND_RESET_I(1);
    ...
    vlSelf->soc_top__DOT__s1_mac__DOT__ctrl_reg = VL_RAND_RESET_I(32);
    vlSelf->soc_top__DOT__s1_mac__DOT__wgt_reg = VL_RAND_RESET_I(32);
    vlSelf->soc_top__DOT__s1_mac__DOT__act_reg = VL_RAND_RESET_I(32);
    vlSelf->soc_top__DOT__s1_mac__DOT__res_reg = VL_RAND_RESET_I(32);
    vlSelf->soc_top__DOT__s1_mac__DOT__w_val = VL_RAND_RESET_I(8);
    vlSelf->soc_top__DOT__s1_mac__DOT__a_val = VL_RAND_RESET_I(8);
    vlSelf->soc_top__DOT__s1_mac__DOT__prod_val = VL_RAND_RESET_I(16);
